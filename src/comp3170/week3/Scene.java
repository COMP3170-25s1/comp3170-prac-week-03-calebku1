...
public class Scene {
	...
	public Scene() {
		...
		translationMatrix(0.0f,0.6f,transMatrix);
	...
	public void update(float deltaTime) {
		translationMatrix(0.0f,MOVEMENT_SPEED * deltaTime,transMatrix);
		rotationMatrix(ROTATION_SPEED * deltaTime, rotMatrix);
